...
<div id="hero" class="container-fluid d-flex min-vw-100 text-black text-center align-items-center justify-content-center" style="margin-top: 160px; gap: 60px" >
    <div class="flex-column text-start justify-content-center width_hero">
        <h1 class="fw-bold" style="font-size: 40px">COMPETITIVE 
            PROGRAMMING</h1>
        ...
        <div class="d-flex align-items-center gap-3" style="height: 100px">
            {{-- Current event --}}
            <div class="">
                <button class="text-uppercase border-0 text-white px-4" style="background-color: #2D4059">Current Event</button>
            </div>
            <div class="" style="border: 1px solid black; height: 20px"></div>
            <div class="mb-0" >
                <h5 class="mb-0 fw-semibold" style="color: #4F8A8B">79</h5>
...
{{-- ABOUT US --}}
<div id="about" class="container-fluid d-flex min-vw-100 p-5 text-black align-items-center justify-content-center" style="gap: 60px; margin-top: 140px; background-color: #F8F1F1">
    <div>
...
<div id="division" class="container-fluid text-center justify-content-center align-items-center" style="margin-top: 140px;">
    ...
    <h1 class="fw-bold">Competitive Programming</h1>
    <div class="container">
        <img class="img-fluid" width="100%" src="{{ url('assets/img/comp_struc.png') }}" alt="">
    </div>
</div>
{{-- DIVISION END  --}}

{{-- KEGIATAN --}}
<div id="division" class="container-fluid p-5 text-center justify-content-center align-items-center" style="margin-top: 140px; background-color: #F8F1F1">
